  ...
  for (auto bag_it = view_li.begin(); bag_it != view_li.end(); bag_it++) {
    // Regular TF data
    {
      ...
      // Optitrack transform
        ...
        opti_py.push_back(oPa(1));
        opti_pz.push_back(oPa(2));
        opti_qw.push_back(vt->transform.rotation.w);
        opti_qx.push_back(vt->transform.rotation.x);
        opti_qy.push_back(vt->transform.rotation.y);
        opti_qz.push_back(vt->transform.rotation.z);
        opti_t.push_back(opti_time.toSec() - time0);
